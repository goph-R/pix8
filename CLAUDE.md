...
- **Menus** (`app.js`): File (New, Open, Close Tab, Save, Import as Layer, Export), Edit, View, Image (Resize, Rotate Left/Right), Layer (Merge Selected, Merge All). Dropdown items support `disabled: true` for conditional availability.
